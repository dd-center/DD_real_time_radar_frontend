    ...
    <div class="item" v-else v-for="(user, index) in data" :key="user.name">
      ...
      <div class="icon">
          ...
          <b-row class="row no-gutters">
            <b-col class="inner">
                <p v-if="[23072573, 15786749, 2025122, 1435101, 2907459, 3992958, 9572567, 1294271, 13967, 1398630, 12892870, 27212086, 12283738, 2327813, 24936979, 42522, 28232182].includes(user.uid)">
...
<!--          <b-tooltip target="tooltip-button-variant3"  triggers="click">Danger variant tooltip</b-tooltip>-->
      </div>
      <div class="detail">
